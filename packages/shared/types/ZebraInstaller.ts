...
export interface ZebraInstallerInterface extends utils.Interface {
  functions: {
    ...
    "install(address,address)": FunctionFragment;
...
export interface ZebraInstaller extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZebraInstallerInterface;
