...
export interface PaymentInterface extends utils.Interface {
  functions: {
    ...
    "testClaimDevFees()": FunctionFragment;
    "testClaimRents()": FunctionFragment;
    "testRevertIfPayTooLow()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testClaimDevFees",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testClaimRents",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testRevertIfPayTooLow",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Payment extends BaseContract {
  ...
  callStatic: {
    ...
    testClaimDevFees(overrides?: CallOverrides): Promise<void>;

    testClaimRents(overrides?: CallOverrides): Promise<void>;

    testRevertIfPayTooLow(overrides?: CallOverrides): Promise<void>;
