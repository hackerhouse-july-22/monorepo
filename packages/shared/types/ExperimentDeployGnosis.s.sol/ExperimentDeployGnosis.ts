...
export interface ExperimentDeployGnosisInterface extends utils.Interface {
  functions: {
...
export interface ExperimentDeployGnosis extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExperimentDeployGnosisInterface;
