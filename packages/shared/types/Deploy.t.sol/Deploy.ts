...
export interface DeployInterface extends utils.Interface {
  functions: {
    ...
    "testExecTxThatFail()": FunctionFragment;
    "testSafeExecTx()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testExecTxThatFail",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSafeExecTx",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Deploy extends BaseContract {
  ...
  callStatic: {
    ...
    testExecTxThatFail(overrides?: CallOverrides): Promise<void>;

    testSafeExecTx(overrides?: CallOverrides): Promise<void>;
