export const SnookAbi = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "afterdeath", type: "address" },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "tokenId", type: "uint256" },
      { internalType: "uint256", name: "killerTokenId", type: "uint256" },
    ],
    name: "setKillerTokenId",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
