...
type ListNftModalProps = {
  isOpen: boolean;
  onClose: () => void;
  onEdit: (data: ListNftModalData) => void;
  defaults?: Partial<ListNftModalData>;
};
...
const ListNftModal: React.FC<ListNftModalProps> = ({
  ...
  const onSubmit = (values: ListNftModalData) => {
    onEdit(values);
    reset();
    onClose();
  };
